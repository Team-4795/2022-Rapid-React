...
public class Climber extends SubsystemBase {
  ...
  private final DoubleSolenoid solenoid = new DoubleSolenoid(1, PneumaticsModuleType.REVPH, ClimberConstants.FORWARD_CHANNEL, ClimberConstants.REVERSE_CHANNEL); //
